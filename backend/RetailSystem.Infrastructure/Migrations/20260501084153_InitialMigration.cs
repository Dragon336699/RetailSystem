    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVariantCarts_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariantCarts_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0556ff05-847a-15b0-5b60-43f5f5edc38b"), 37.5m },
                    { new Guid("37998cb6-2e7b-d624-1cc3-b8097007123b"), 41.5m },
                    { new Guid("38f0a9e8-f01c-5d67-4ab9-f6375f465566"), 36.0m },
                    { new Guid("47b2b3c0-e74f-cf61-d0d5-d3e095b14a2d"), 39.0m },
                    { new Guid("61b40c18-8179-1b09-542d-50df55640536"), 39.5m },
                    { new Guid("8b426ebc-22bc-be99-298f-ae06cab8249b"), 40.5m },
                    { new Guid("8e88205a-4654-4fd5-d446-036188f05757"), 38.0m },
                    { new Guid("9e932f74-5de7-acce-212c-383678d13ff6"), 38.5m },
                    { new Guid("a3792ddf-bbad-5904-abee-f68200dbe8ca"), 37.0m },
                    { new Guid("a9c47057-28a2-591d-8a08-2129e51b58da"), 42.5m },
                    { new Guid("d02d1b04-6ae9-c399-569c-f0ec83bdb0a3"), 41.0m },
                    { new Guid("d44b4943-f810-33f1-ac9a-e4f84eedbbca"), 42.0m },
                    { new Guid("d527d119-c906-5b61-ef5c-5175e55d188a"), 40.0m },
                    { new Guid("e4089c57-d805-56c9-82dc-eb733e4fa6c6"), 43.0m },
                    { new Guid("fa2fc897-eb4a-5e36-b753-5469a9304953"), 36.5m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantCarts_CartId",
                table: "ProductVariantCarts",
                column: "CartId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantCarts_ProductVariantId",
                table: "ProductVariantCarts",
                column: "ProductVariantId");
